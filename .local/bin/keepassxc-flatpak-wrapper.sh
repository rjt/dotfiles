...
readonly kpxcfp='flatpak run org.keepassxc.KeePassXC'
...
# https://github.com/keepassxreboot/keepassxc/blob/latest/utils/keepassxc-flatpak-wrapper.sh
# https://raw.githubusercontent.com/keepassxreboot/keepassxc/3cbe4df8c753bc17197cf8615948a275ea524d96/utils/keepassxc-flatpak-wrapper.sh
# KeePassXC and Firefox stopped Talking when Firefox went Flatpak.  
# Now that both are Flatpaks, i hope this script works.
# 
